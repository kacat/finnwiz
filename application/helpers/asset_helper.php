...
function create_version_nbr($asset_path)
{
	$ver = filemtime(FCPATH.$asset_path);
	return $asset_path."?".$ver;
}
...
function other_asset_url($asset_name, $asset_type = NULL)
{
	$obj =& get_instance();
	...
	$asset_location = create_version_nbr('assets/'.$asset_type.'/'.$asset_name);
...
function css_asset_url($asset_name)
{
	return other_asset_url($asset_name, 'css');
}
...
function image_asset_url($asset_name)
{
	return other_asset_url($asset_name, 'images');
}
...
function js_asset_url($asset_name)
{
	return other_asset_url($asset_name, 'js');
}
